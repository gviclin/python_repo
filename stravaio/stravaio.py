...
class StravaIO():
    ...
    def get_logged_in_athlete_activities(self, after=0, page=0,per_page=30, list_activities=None):
        ...
        _fetched = self.activities_api.get_logged_in_athlete_activities(after=after, per_page=per_page)
        if len(_fetched) > 0:
            ...
            if len(_fetched) == per_page:
                ...
                return self.get_logged_in_athlete_activities(after=last_after, per_page=per_page,list_activities=list_activities)
        else:
            print("empty list")
